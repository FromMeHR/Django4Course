...
class UserProfileView(LoginRequiredMixin, CacheMixin, UpdateView): # or FormView
    ...
    def get_context_data(self, **kwargs):
        ...
        context['orders'] = self.set_get_cache(orders, f"user_orders_{self.request.user.id}", 60 * 2)
        return context
